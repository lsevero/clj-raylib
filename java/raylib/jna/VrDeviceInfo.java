...
public class VrDeviceInfo extends Structure{
    ...
    public VrDeviceInfo(VrDeviceInfo v){
        super();
        this.hResolution = v.hResolution;
        this.vResolution = v.vResolution;
        this.hScreenSize = v.hScreenSize;
        this.vScreenSize = v.vScreenSize;
        this.vScreenCenter = v.vScreenCenter;
        this.eyeToScreenDistance = v.eyeToScreenDistance;
        this.lensSeparationDistance = v.lensSeparationDistance;
        this.interpupillaryDistance = v.interpupillaryDistance;
        this.lensDistortionValues = v.lensDistortionValues;
        this.chromaAbCorrection = v.chromaAbCorrection;
    }

    public VrDeviceInfo(Object obj) throws IllegalArgumentException{
        super();
        if(obj instanceof VrDeviceInfo){
            VrDeviceInfo v = (VrDeviceInfo)obj;
            this.hResolution = v.hResolution;
            this.vResolution = v.vResolution;
            this.hScreenSize = v.hScreenSize;
            this.vScreenSize = v.vScreenSize;
